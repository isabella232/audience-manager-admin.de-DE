---
description: Liste der Makros, die Sie zum Erstellen von HTTP-Datendateien verwenden können. HTTP sendet Daten im JSON-Format.
seo-description: Liste der Makros, die Sie zum Erstellen von HTTP-Datendateien verwenden können. HTTP sendet Daten im JSON-Format.
...
<table id="table_72A72EA63C3643FB84B47A76CD2CC1CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Gibt eine Liste von Segment-IDs zurück, für die ein Benutzer nicht mehr qualifiziert ist. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>REMOVED_SEGMENTS</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Eine Liste von Segmenten, für die ein Benutzer nicht mehr qualifiziert ist. Sie können auch bestimmte Segmentfelder zurückgeben, die Folgendes umfassen: </p> <p> 
     ...
     </ul> </p> <p>Geben Sie diese Felder in einem Array an, wie im folgenden Beispiel gezeigt: </p> <p> <code>[&lt;REMOVED_SEGMENTS:{seg|&lt;OPEN_BRACKET&gt;"Mapping":&lt;seg.traitAlias&gt;,"Status:"&lt;seg.status&gt;, "Time":&lt;seg.dateTime&gt;,"LegacySegmentId":&lt;seg.LegacySegmentId&gt;, "NewSegmentId":&lt;seg.NewSegmentId&gt;&lt;CLOSE_BRACKET&gt;}; "separator=","&gt;]</code> </p> <p>Siehe auch <a href="../formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> Beispiele für HTTP-Format-Makros </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Eine Liste von Segmentnamen mit Alias, für die ein Benutzer nicht mehr qualifiziert ist. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Eine Liste von Segmenten, für die ein Benutzer qualifiziert ist. Sie können auch bestimmte Segmentfelder zurückgeben, die Folgendes umfassen: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Eine Liste letzter Erkenntnis. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Eine Liste von Alias-Namen für ein bestimmtes Segment. </p> </td> 
  </tr> 
  <tr> 
