...
Listet die Makros auf, die Sie zum Erstellen von [!DNL HTTP] Datendateien verwenden können. [!DNL HTTP] sendet Daten in einem [!DNL JSON] Format.

Eine Liste mit Beispielen für gebräuchliche Makrokombinationen finden Sie in den [HTTP-Format-Makrobeispielen](../formats/web-format-examples.md) .
...
<table id="table_72A72EA63C3643FB84B47A76CD2CC1CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Experience Cloud-ID. (MCID steht für Marketing Cloud, der veraltete Name der Experience Cloud) </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET, POST</code> </p> </td> 
   <td colname="col3"> <p>Ein Alias für die Partner-ID. Auch als Auslandskonto-ID bezeichnet. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>RANDOM</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Erstellt eine Zufallszahl. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>REGION_ID_LIST</code> </p> </td> 
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Die DCS-Region <a href="https://docs.adobe.com/help/en/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/dcs-regions.html"> von Audience Manager, </a> in der die Aktivität ihren Ursprung hat.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Eine Liste der Segmente, für die ein Benutzer nicht mehr qualifiziert ist. Sie können auch bestimmte Segmentfelder zurückgeben, die Folgendes umfassen: </p> <p> 
     ...
     </ul> </p> <p>Geben Sie diese Felder in einem Array an, wie im folgenden Beispiel gezeigt: </p> <p> <code>[&lt;REMOVED_SEGMENTS:{seg|&lt;OPEN_BRACKET&gt;"Mapping":&lt;seg.traitAlias&gt;,"Status:"&lt;seg.status&gt;, "Time":&lt;seg.dateTime&gt;,"LegacySegmentId":&lt;seg.LegacySegmentId&gt;, "NewSegmentId":&lt;seg.NewSegment id&gt;&lt;CLOSE_BRACKET&gt;}; "separator=","&gt;]</code> </p> <p>Siehe auch <a href="../formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> Beispiele für HTTP-Format-Makros </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Eine Liste mit Namen von Segmenten mit Alias, für die ein Benutzer nicht mehr qualifiziert ist. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Eine Liste der Segmente, für die ein Benutzer qualifiziert ist. Sie können auch bestimmte Segmentfelder zurückgeben, die Folgendes umfassen: </p> <p> 
     ...
     </ul> </p> <p>Geben Sie diese Felder in einem Array an, wie im folgenden Beispiel gezeigt: </p> <p> <code>[&lt;SEGMENTE:{seg|&lt;OPEN_BRACKET&gt;"Mapping":&lt;seg.traitAlias&gt;,"Status:"&lt;seg.status&gt;, "Time":&lt;seg.dateTime&gt;,"LegacySegmentId":&lt;seg.LegacySegmentId&gt;, "NewSegmentId":&lt;seg.NewSegmentId&gt; SE_BRACKET&gt;}; "separator=","&gt;]</code> </p> <p>Siehe auch <a href="../formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> Beispiele für HTTP-Format-Makros </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <code>GET</code> </p> </td> 
   <td colname="col3"> <p>Benutzeragent der ursprünglichen Anforderung. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>USER_LIST</code> </p> </td> 
   <td colname="col2"> <p> <code>POST</code> </p> </td> 
   <td colname="col3"> <p>Eine Liste der <span class="keyword"> Audience Manager- </span> Benutzer-IDs. Sie können auch bestimmte Felder zurückgeben, die Folgendes umfassen: </p> 
